...
const About = () => {
  return (
    <div className='content-grid'>
      ...
      <section className={`image-text-section right margin-xl`}>
      ...
      <main>
        <section className={`${styles.seniorEmployees} margin-xxl`}>
          <TeamMemberInfo
        ...
        <section className={`${styles.employeeGrid} margin-l`}>
          <Link href='#lucas-johnson'>
            <DecorativeImage
              src='/images/about-page/lucas-johnson-decor-&-design-consultant.jpg'
              alt='Lucas Johnson'
        ...
        <section className={`${styles.juniorEmployees}`}>
          <TeamMemberInfo
            id='lucas-johnson'
            name='Lucas Johnson'
